...
import com.example.pillmate.databinding.ActivityHelp6Binding

class Help6Activity : AppCompatActivity() {

    private lateinit var binding: ActivityHelp6Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHelp6Binding.inflate(layoutInflater)
