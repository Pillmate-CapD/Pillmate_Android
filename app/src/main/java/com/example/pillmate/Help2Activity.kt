...
import com.example.pillmate.databinding.ActivityHelp2Binding

class Help2Activity : AppCompatActivity() {

    private lateinit var binding: ActivityHelp2Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHelp2Binding.inflate(layoutInflater)
...
//            navigateToUserFragment()
        ...
        binding.nextIcon.setOnClickListener {
            val intent = Intent(this, Help3Activity::class.java)
