...
import com.example.pillmate.databinding.ActivityHelp5Binding

class Help5Activity : AppCompatActivity() {

    private lateinit var binding: ActivityHelp5Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHelp5Binding.inflate(layoutInflater)
        ...
        binding.nextIcon.setOnClickListener {
            val intent = Intent(this, Help6Activity::class.java)
